...
// EntryMappingDetail defines model for EntryMappingDetail.
type EntryMappingDetail struct {
	// Id The unique identifier of this entry.
	Id               EntryMappingId                            `json:"id"`
	RetrieverDetails []EntryMappingDetailRetrieverDetailsInner `json:"retrieverDetails"`
}

// EntryMappingDetailRetrieverDetailsInner defines model for EntryMappingDetail_retrieverDetails_inner.
type EntryMappingDetailRetrieverDetailsInner struct {
	ApiResp string `json:"apiResp"`

	// Id Id used to identify retrievers.
	Id RetrieverId `json:"id"`
}

// EntryMappingId The unique identifier of this entry.
type EntryMappingId = string
