...
func TestEntryMappingManager_parseEntryMapping(t *testing.T) {
	...
	t.Run("parses simple single-retriever entry mappings", func(t *testing.T) {
		...
		var err error
		entryMappings, err = instance.parseEntryMapping("Some Film", "69914146", utils.ParseTime("2025-02-17T19:32:07Z"), entryMappings)
		entryMappings, err = instance.parseEntryMapping("Another film", "7b74ad25", utils.ParseTime("2025-03-18T09:32:01Z"), entryMappings)
		assert.Nil(t, err)
		assert.Equal(t, []*common.EntryMapping{
			{"Some Film", utils.ParseTime("2025-02-17T19:32:07Z"), []common.RetrieverInfo{retriever1}},
	...
	t.Run("parses multi-retriever entry mappings", func(t *testing.T) {
		...
		var entryMappings []*common.EntryMapping
		var err error
		entryMappings, err = instance.parseEntryMapping("Some Film", "69914146", utils.ParseTime("2025-02-17T22:00:00Z"), entryMappings)
		entryMappings, err = instance.parseEntryMapping("Some Film", "7b74ad25", utils.ParseTime("2025-02-17T19:00:00Z"), entryMappings)
		entryMappings, err = instance.parseEntryMapping("Some Film", "49192bf4", utils.ParseTime("2025-02-17T21:00:00Z"), entryMappings)
		entryMappings, err = instance.parseEntryMapping("Another film", "7b74ad25", utils.ParseTime("2025-03-18T09:32:01Z"), entryMappings)
		assert.Nil(t, err)
		assert.Equal(t, []*common.EntryMapping{
